...
here_car = RouterWrapper.create!(
    ...
    url_time: 'http://localhost:4899',
    options: {time: true, distance: true, avoid_zones: true, isochrone: false, isodistance: false, motorway: true, toll: true, trailers: false, weight: false, weight_per_axle: false, height: false, width: false, length: false, hazardous_goods: false, strict_restriction: false, traffic: true})
here_truck = RouterWrapper.create!(
    mode: 'truck',
    name: 'RouterWrapper-HereTruck',
    name_locale: {fr: 'Calculateur pour camion', en: 'Truck router'},
    url_time: 'http://localhost:4899',
    options: {time: true, distance: false, avoid_zones: true, isochrone: false, isodistance: false, motorway: true, toll: true, trailers: true, weight: true, weight_per_axle: true, height: true, width: true, length: true, hazardous_goods: true, strict_restriction: true, traffic: true})
...
profile_all = Profile.create!(name: "All", layers: [mapnik_fr, mapnik, mapbox, stamen_bw, here_layer], routers: [car, car_urban, bicycle, pedestrian, here_car, here_truck, public_transport])
